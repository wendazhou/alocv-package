...
#include "examples/lasso_example.in"
    ...
    lasso_compute_alo_d(n, p, num_tuning, x, n, beta, p, y, 1, nullptr, 1e-5, alo.data(), leverage.data());
...
#include "examples/lasso_example.in"
    ...
    lasso_compute_alo_d(n, p, num_tuning, x, n, beta, p, y, 1, nullptr, 1e-5, alo.data(), nullptr);
